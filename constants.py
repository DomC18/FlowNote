...
DELETE_ICON = UI_PATH + r"\delete.png"
EDIT_ICON = UI_PATH + r"\edit.png"
EDITLARGE_ICON = UI_PATH + r"\editlarge.png"
EDITMEDIUM_ICON = UI_PATH + r"\editmedium.png"
CENTER_ICON = UI_PATH + r"\center.png"
CENTERSMALL_ICON = UI_PATH + r"\centersmall.png"
